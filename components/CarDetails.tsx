...
const CarDetails = ({isOpen, closeModel, car}: CarDetaialsProps) => {
  return (
    <>
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as='div' className='relative z-10' onClose={closeModel}>
                <Transition.Child as={Fragment} 
                                  ...
                                  leave='ease-in duration-200' leaveFrom='opavity-100' leaveTo='opacity-0' >
                    ...
                    <div className='fixed inset-0 overflow-y-auto'>
                        ...
                        <Transition.Child as={Fragment} 
                                  ...
                                  leave='ease-in duration-200' leaveFrom='opavity-100 scale-100' leaveTo='opacity-0 scale-95' >
